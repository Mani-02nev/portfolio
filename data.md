# Portfolio Data — Karuppasamy M

> Complete data export from the portfolio site. Source: `src/data/portfolioData.ts` and section components.
...
| Field | Value |
|-------|-------|
| **Title** | KARUPPASAMY M \| Frontend Developer & AI Specialist |
| **Description** | Portfolio of KARUPPASAMY M, a high-impact Frontend Developer and AI/ML enthusiast specializing in building intelligent, scalable, and elegant software solutions. |
| **Keywords** | Frontend Developer, React Specialist, AI Engineer, ML Specialist, DevOps, TypeScript, Python, Portfolio, KARUPPASAMY M |
| **Brand** | Mr K AI Ecosystem |
| **Tech Stack (Site)** | React, TypeScript, Tailwind CSS, Vite, Framer Motion, Three.js |
...
- **Greeting:** Hi, I'm Karuppasamy M
- **Headline:** Building The Future with [Intelligent / Scalable / Innovative] AI & Web Solutions
- **Subtext:** Founder of Mr K AI Ecosystem — Building intelligent systems that redefine possibilities through AI innovation and scalable engineering.

### About Section Highlights

- **Tagline:** Engineering Maturity Meets Innovation
- **Academic Foundation:** Currently pursuing degree at Seshasayee Institute of Technology in Tiruchirappalli.
- **Professional Experience Summary:** Applied AI and systems engineering skills across enterprise and startup settings — from Novi Tech analytics dashboards to VDart's AI/ML automation pipelines and Google's campus developer community.
- **Approach:** Holistic — considers DevOps efficiency, user experience, and long-term scalability.
...
| Metric | Value |
|--------|-------|
| Learning Velocity (6 months) | +142% |
| Model Accuracy | 94.8% |
| Git Commits | 240+ |
| SaaS Deployments | 5 |
| Weekly Avg Commits | 60 commits/wk |
| Daily Avg Coding Hours | 7.3 hrs/day |

### Domain Proficiency (ChatBot)

| Domain | Proficiency |
|--------|-------------|
| AI & Machine Learning | 95% |
| Full-Stack React/Next.js | 90% |
...
**Technologies:** Computer Science, Algorithms, Systems Design, Engineering
...
| **Type** | Internship |
| **Certificate** | /certificates/KARUPPASAMY M (3).pdf |
...
**Technologies:** Data Analytics, Excel, Tableau, Statistics, SQL

---

### 3. AI & ML Engineering Intern
...
| **Period** | Summer 2024 |
| **Type** | Internship |
| **Certificate** | /certificates/KARUPPASAMY M (2).pdf |
...
**Technologies:** AI/ML, React, Python, Tailwind CSS, Chart.js

---

### 4. AI & ML Engineering Intern
...
| **Period** | 2025 |
| **Type** | Internship |
| **Certificate** | /certificates/vdart-internship.svg |
...
**Technologies:** Python, Machine Learning, NLP, Computer Vision, FastAPI, TensorFlow

---

### 5. Google Campus Ambassador
...
**Technologies:** Google Cloud, Android, AI/ML, Community Leadership, Developer Relations
...
### Web Frameworks
React.js, Next.js, Django, Tailwind CSS

### App Frameworks
Flutter, React Native

### UI & Design Tools
Responsive Design, UI/UX Principles, Figma, Component Architecture

### AI & ML
TensorFlow, PyTorch, Scikit-learn, NLP, Computer Vision

### DevOps & Tools
Linux, Unix, DevOps, Git, GitHub
...
| Skill | Description |
|-------|-------------|
| **Leadership** | Proven ability to guide teams towards shared goals, fostering a culture of excellence and accountability. |
| **Communication** | Expertise in translating complex technical concepts for non-technical stakeholders and cross-functional teams. |
| **People Management** | Committed to mentoring peers and managing group dynamics to optimize productivity and morale. |
| **Time & Task Management** | Detail-oriented approach to project timelines and task prioritization, ensuring high-quality delivery under pressure. |
| **Collaboration** | Prioritizing team success through active listening, conflict resolution, and shared responsibility. |
| **Professional Integrity** | Upholding high standards of ethics, reliability, and engineering discipline in every project. |
| **Adaptability** | Thrives in dynamic environments, quickly adjusting to new technologies and shifting project requirements. |
| **Empathy** | Understanding user needs and team perspectives to create inclusive solutions and foster a supportive work environment. |
...
### 5. AI Health Analytics & Sugar Predict
...
- **Live URL:** https://agent02.vercel.app/
...
**CTA:** Let's Build Something Legendary

---

## ChatBot — Mr K Analytics Engine

**Name:** Mr K Analytics Engine  
**Greeting:** Hi! I'm the Mr K Analytics Engine. How can I help you explore Karuppasamy's career metrics today?
...
### Value Proposition
Karuppasamy brings rare technical versatility: combining solid systems foundations (Diploma in Computer Engineering) with practical AI/ML model deployment (VDart, Novi Tech) and community representation (Google Campus Ambassador). He works with high accuracy, fast turnaround, and values premium UX/UI styling.

---

## Footer

© 2026 Karuppasamy M. All rights reserved. Built with React & Tailwind CSS.
...
### Company Logos
- Google, VDart Inc., Novi Tech Company, Seshasayee Institute of Technology (SIT)
...
- /data_analytics.png
- /health_analytics.png
- /ks_resume_builder.png
- /agent_k_dashboard.png
- /univault_ecommerce.png
...
- /certificates/KARUPPASAMY M (2).pdf
- /certificates/KARUPPASAMY M (3).pdf
- /certificates/KARUPPASAMY M.pdf
- /certificates/HCL GUVI Certification - 1h6nM1sg71C5972067.png
- /certificates/5-Day AI Agents Intensive Course with Google.png
- /certificates/maang.png
